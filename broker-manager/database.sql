...
CREATE TABLE IF NOT EXISTS Topic (
    ...
    parition_id INTEGER NOT NULL DEFAULT 0,
    broker_id INTEGER,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (broker_id) REFERENCES Broker(broker_id),
    PRIMARY KEY (topic_name, parition_id)
);
...
CREATE TABLE IF NOT EXISTS Consumer (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (topic_name, parition_id) REFERENCES Topic(topic_name, parition_id),
...
CREATE TABLE IF NOT EXISTS ConsumerPartition (
    ...
    PRIMARY KEY (consumer_id, parition_id)
);
